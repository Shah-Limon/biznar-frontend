...
const Footer = () => {
  ...
  return (
    <>
      ...
      <div>
        <footer className="footer bg-black text-light de-padding pos-rel overflow-hidden hero-bg">
          <img
            src="assets/img/bg/bg-layered.png"
            alt="no image"
          ...
          <div className="container">
            <div className="row g-5">
              <div className="col-lg-5 col-md-6">
                <div className="footer-widget pr-50">
                  <div className="recent-post-wrp">
                    <div className="footer-logo">
                      {logo.map((show) => (
                        <img src={show.logo} alt="Logo" />
                      ))}
                      {footer.map((e) => (
                        <p>{e.FooterAbout}</p>
                      ))}
