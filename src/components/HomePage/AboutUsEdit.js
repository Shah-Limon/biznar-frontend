...
const SpecialityOptionEdit = () => {
  ...
  const handleEditAbout = async (event) => {
    ...
    const topTitle = event.target.topTitle.value;
        ...
        {about.map((e) => (
          <div class="container">
            <div class="justify-content-center align-items-baseline">
              ...
              <div class="col-sm">
                <label className="mt-1">Title Top Heading</label>
                <div class="form-group mb-3">
                  <input
                    type="text"
                    class="form-control"
                    placeholder="Title Top Heading"
                    name="topTitle"
                    defaultValue={e.topTitle}
                  />
                </div>
              </div>
              <div class="col-sm">
              ...
              <div class="col-sm">
                <label className="mt-1">About Button URL</label>
                <div class="form-group mb-3">
                  <input
                    type="text"
                    class="form-control"
